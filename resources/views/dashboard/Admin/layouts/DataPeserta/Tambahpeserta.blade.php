...
<div class="col-lg-8">
    <form action="/dashboard/Admin/layouts/DataPeserta/Tambahpeserta" method="post">
      @csrf
        <div class="cf-cover">
          ...
          <div class="form-floating mb-2">
            <div class="col-md-12">
              ...
              <input type="text" name="Nama_peserta" class="form-control rounded-top @error('Nama_peserta')is-invalid @enderror" id="Nama_peserta"  pattern="^[a-zA-Z\s'-/,.]{1,100}$" placeholder="Masukan Nama Lengkap" required value="{{ old('Nama_peserta') }}">
              @error('Nama_peserta')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
         ...
         <div class="form-floating mb-2">
          ...
          <div class="form-floating mb-2">
            <div class="col-md-12">
              ...
              <input type="text" name="alamat" class="form-control rounded-top @error('alamat')is-invalid @enderror" id="alamat"  placeholder="Masukan Alamat Lengkap" required value="{{ old('alamat') }}">
              @error('alamat')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
                   ...
                   <div class="modal-dialog" role="document">
                       <div class="modal-content">
                           ...
                           <div class="modal-footer">
                               <a class="btn btn-primary" href="/dashboard/Admin/layouts/DataPeserta/Tambahpeserta">Tidak</a>
